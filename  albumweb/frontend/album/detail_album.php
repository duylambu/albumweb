...
{?>
<div id="photo-item">
<div id="photo-image"><a rel="popup_name" class="poplight" href="#?w=600&aid=<?php echo $row['album_id'] ?>&photoid=<?php echo $row['photo_id']?>"><img id="image" src="upload/<?php echo $userid;?>/<?php echo $row['album_id'];?>/<?php echo $row['image'];?>"/></a></div>
